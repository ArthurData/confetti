...
fusen::fill_description(
  pkg = here::here(),
  fields = list(
    Title = "Put Some Confetti In Your Shiny Application",
    Description = "An helper to call a Javascript library to send some confetti in a shiny app.",
    `Authors@R` = c(
      person("Arthur", "Bréant", email = "arthur@thinkr.fr", role = c("aut", "cre"))
    )
  )
)
...
# Code of Conduct
usethis::use_code_of_conduct("arthur@thinkr.fr")
# NEWS
usethis::use_news_md()
```
